...
function SocialLink({ label, href, children }: { label: string; href: string; children: React.ReactNode }) {
  return (
    <a
      href={href}
      aria-label={label}
      className="flex h-10 w-10 items-center justify-center rounded-full border border-border text-foreground/90 hover:text-gold hover:border-gold/40 transition-colors"
    >
      {children}
    </a>
  )
    ...
    <section className="relative z-10 px-4 py-16 lg:py-24">
      ...
      <div className="mx-auto max-w-6xl">
        <FadeIn>
          <div className="text-center mb-12">
            ...
            <p className="mx-auto mt-4 max-w-lg text-foreground/80">
              Have questions about your claim? Reach out to us by phone, email, or the form below.
            </p>
          </div>
        </FadeIn>
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          {/* Information Section - Bottom on mobile (order-2), Left on desktop (lg:order-1) */}
          <div className="order-2 lg:order-1">
            <FadeIn delay={0.2}>
              <div className="glass-light rounded-2xl p-8 h-full flex flex-col">

                <div className="mb-10">
                  <h2 className="text-2xl font-bold text-foreground mb-3">Contact Us for a Free Consultation</h2>
                  <p className="text-sm text-foreground/80 leading-relaxed mb-8">
                    Let us help you recover the value of your vehicle! Reach out today for expert guidance and support.
                  </p>
                ...
                <div className="border-t border-border pt-8 mt-auto">
                  ...
                  >
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gold/10 text-gold group-hover:bg-gold/20 transition-colors shrink-0">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-base font-semibold text-foreground group-hover:text-gold transition-colors">info@dvhive.com</p>
                    </div>
                  </a>
                  ...
                  <div className="border-t border-border pt-6">
                    <p className="text-xs font-bold uppercase tracking-wider text-gold mb-3">Follow Us</p>
                    <div className="flex gap-3">
                      <SocialLink label="Instagram" href="https://www.instagram.com/dvhivve/">
                      ...
                      <SocialLink label="LinkedIn" href="https://www.linkedin.com/company/dvhive/">
                        <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
                      </SocialLink>
                      <SocialLink label="YouTube" href="https://www.youtube.com/channel/UCUqWQcg46YCCukVkJFXhG9Q">
          ...
          {/* Contact form Section - Top on mobile (order-1), Right on desktop (lg:order-2) */}
