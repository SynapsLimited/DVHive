        ...
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <FadeIn delay={0.1}>
            <div className="glass-light rounded-2xl p-8 h-full">
              ...
              <a
                href="mailto:support@dvhive.com"
                className="flex items-center gap-4 mb-6 group"
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gold/10 text-gold group-hover:bg-gold/20 transition-colors shrink-0">
                ...
                <div>
                  <p className="text-xs text-foreground/40 font-medium">Email</p>
                  <p className="text-base font-semibold text-foreground group-hover:text-gold transition-colors">support@dvhive.com</p>
                </div>
              </a>
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <p className="text-xs text-foreground/40 font-medium">Address</p>
                  <p className="text-sm text-foreground/80">Serving all 50 states nationwide</p>
                </div>
              </div>
